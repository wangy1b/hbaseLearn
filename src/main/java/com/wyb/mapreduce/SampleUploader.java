...
public class SampleUploader extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        args = new String[]{"C:\\Users\\32006\\IdeaProjects\\hbaseLearn\\src\\main\\resources\\input.csv","datasample"};
        HBaseUtils.createTable("datasample","cf1");
